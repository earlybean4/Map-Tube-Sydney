package Map::Tube::Sydney::Line::T6;

$Map::Tube::Sydney::Line::T6::VERSION   = '1.00';
$Map::Tube::Sydney::Line::T6::AUTHORITY = 'cpan:EARLYBEAN4';
...
Map::Tube::Sydney::Line::T6 - Sydney Rail Map: T6 Line.
...
Sydney Rail Map: T6 Line.

    +--------------+------------------------+
    | Station Name | Connected To           |
    +--------------+------------------------+
    | Bankstown    | Yagoona                |
    | Yagoona      | Bankstown, Birrong     |
    | Birrong      | Yagoona, Regents Park  |
    | Regents Park | Birrong, Berala        |
    | Berala       | Regents Park, Lidcombe |
    | Lidcombe     | Berala                 |
    +--------------+------------------------+
...
Sydney Rail Map: L<T6 Line|https://raw.githubusercontent.com/earlybean4/Map-Tube-Sydney/master/maps/T6.png>
map generated by plugin L<Map::Tube::Plugin::Graph>.

=begin html

<a href = "https://raw.githubusercontent.com/earlybean4/Map-Tube-Sydney/master/maps/T6.png">
<img src    = "https://raw.githubusercontent.com/earlybean4/Map-Tube-Sydney/master/maps/T6.png"
     alt    = "Sydney Rail Map: T6 Line"
     width  = "500px"
     height = "500px"/>
</a>
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Map::Tube::Sydney::Line::T6
...
1; # End of Map::Tube::Sydney::Line::T6
